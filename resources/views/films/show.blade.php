...
<div id="face" itemscope="" itemtype="http://schema.org/Movie">
  	 <div id="single">
         ...
         <div class="t-row">
           ...
           <div class="r-2"><div class="rl-1">год</div><div class="rl-2" itemprop="dateCreated"><a href="/year/in-{{$film->year}}/" rel="tag">{{$film->year}}</a></div></div>
           <div class="r-1"><div class="rl-1">страна</div><div class="rl-2"><a href="https://gidonline.io/country/usa/" rel="tag">{{$film->country}}</a></div></div>
           ...
           <a href="https://gidonline.io/translation/dubbed/" rel="tag">дублированный</a>, <a href="https://gidonline.io/limitations/older-16/" rel="tag">16+</a>
                      </div></div>
  ...
  <script type="text/javascript">
   function BgFade11() {
    ...
    document.getElementById('addf11').style.transition = '0.1s';
          ...
          <a id="addf" href="javascript:;" class="favorite_but" onclick="alert('Чтобы добавить фильм в избранное необходимо зарегистрироваться')"><span id="fav_but_add"></span><span id="fav_but_txt">Избранное</span></a>
